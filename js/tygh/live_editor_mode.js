  ...
  var methods = {
    ...
    dispatch: function dispatch(e) {
      ...
      if (e.type == 'click') {
        if (jelm.closest('.cm-icon-live-edit').length) {
          ...
          t_elm.editable('show'); // Select text

          $('.editable-input input, .editable-input textarea').select(); // Init wysiwyg
    ...
    load: function load(content) {
      $('[data-ca-live-editor-obj]', content).each(function () {
        ...
        elm.wrap('<var class="live-edit-wrap">').before('<i class="cm-icon-live-edit icon-live-edit ty-icon-live-edit"></i>').html('<var data-ca-live-edit="' + obj_name + '"' + obj_phrase_attr + ' class="cm-live-edit live-edit-item">' + elm_content + '</var>').removeAttr('data-ca-live-editor-obj').removeAttr('data-ca-live-editor-phrase').removeAttr('data-ca-live-editor-need-render').removeAttr('data-ca-live-editor-input-type');
      }); // wrapping
    ...
    init: function init(content) {
      ...
      $.fn.editable.defaults.mode = 'popup'; // add the class ty-wysiwyg-content for properly display WISYWIG
    ...
    save: function save(value) {
      ...
      $.ceAjax('request', fn_url('design_mode.live_editor_update'), {
        method: 'post',
        data: data,
        callback: function callback(data, params, text) {
