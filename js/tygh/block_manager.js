      ...
      case 'properties':
        if (element_type == 'block') {
          ...
          if ($('#' + prop_container).length == 0) {
            ...
            container_title = _hover_element.find('.block-header > h4').text() || Tygh.tr('editing_block');
      ...
      */
      ...
      if (action == 'new-block') {
        ...
        if (is_manage) {
          ...
          $('.block-header', elm).prop('title', block_title); // Check if the same block already exists in the grid
