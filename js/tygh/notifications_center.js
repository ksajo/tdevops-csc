  ...
  */
  ...
  var _e = {
    ...
    extractEvents: function extractEvents(e, t, n, r) {
      ...
      return o ? (ge && "ko" !== n.locale && (ke || o !== we.compositionStart ? o === we.compositionEnd && ke && (i = ie()) : (re = "value" in (ne = r) ? ne.value : ne.textContent, ke = !0)), o = de.getPooled(o, t, n, r), i ? o.data = i : null !== (i = Ee(n)) && (o.data = i), $(o), i = o) : i = null, (e = ve ? function (e, t) {
        ...
        if (ke) return "compositionend" === e || !me && Te(e, t) ? (e = ie(), oe = re = ne = null, ke = !1, e) : null;
  ...
  function mi(e) {
    if (di) {
      ...
      if (t) {
        ...
        if (!hi(e, t)) {
          if (!(t = Tr(n)) || !hi(e, t)) return e.effectTag |= 2, di = !1, void (si = e);
          pi(si, n);
        }
  ...
  function Ii(e, t, n) {
    ...
    switch (t.expirationTime = 0, t.tag) {
      ...
      case 3:
        return Oi(t), null === (r = t.updateQueue) && a("282"), o = null !== (o = t.memoizedState) ? o.element : null, ea(t, r, t.pendingProps, null, n), (r = t.memoizedState.element) === o ? (gi(), t = Ri(e, t, n)) : (o = t.stateNode, (o = (null === e || null === e.child) && o.hydrate) && (fi = Er(t.stateNode.containerInfo), si = t, o = di = !0), o ? (t.effectTag |= 2, t.child = mo(t, null, r, n)) : (xi(e, t, r, n), gi()), t = t.child), t;

      case 5:
        return Eo(t), null === e && mi(t), r = t.type, o = t.pendingProps, i = null !== e ? e.memoizedProps : null, l = o.children, vr(r, o) ? l = null : null !== i && vr(r, i) && (t.effectTag |= 16), _i(e, t), 1 !== n && 1 & t.mode && o.hidden ? (t.expirationTime = t.childExpirationTime = 1, t = null) : (xi(e, t, l, n), t = t.child), t;
  ...
  function Va(e, t) {
    ...
    for (function (e, t) {
      ...
      eo(0, e);
    }(e, o > r ? o : r), Ea.current = null, r = void 0, 1 < t.effectTag ? null !== t.lastEffect ? (t.lastEffect.nextEffect = t, r = t.firstEffect) : r = t : r = t.firstEffect, hr = kn, mr = function () {
      var e = Ln();
    ...
    for (Un(mr), mr = null, kn = !!hr, hr = null, e.current = t, Ra = r; null !== Ra;) {
      o = !1, l = void 0;
              ...
              if (l = t.type, null !== i && null != t.stateNode) la(i, t, l, u, c), i.ref !== t.ref && (t.effectTag |= 128);else if (u) {
                ...
                if (vi(t)) {
                  ...
                  switch (f) {
                    ...
                    case "textarea":
                      Gn(p, d), c = Yn(p, d), _n("invalid", p), dr(h, "onChange");
                      break;
  ...
  function Ga(e, t) {
    null !== (e = Ya(e, t)) && (!_a && 0 !== Pa && t > Pa && ja(), Xr(e, t), _a && !Ia && Ca === e || xl(e, e.expirationTime), ml > hl && (ml = 0, a("185")));
  }
  ...
  function ie() {
    return (ie = a(o.a.mark(function e(t) {
      var n;
      return o.a.wrap(function (e) {
        for (;;) {
          switch (e.prev = e.next) {
  ...
  function se(e, t) {
    return !t || "object" !== Object(ce.a)(t) && "function" != typeof t ? function (e) {
      if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
      return e;
    }(e) : t;
  }
  ...
  var he = [],
      me = function (e) {
    function t() {
      return Object(le.a)(this, t), se(this, fe(t).apply(this, arguments));
    }

    return pe(t, l["Component"]), Object(ue.a)(t, [{
      key: "render",
    ...
    function t(e) {
      var n;
      return Object(le.a)(this, t), (n = se(this, fe(t).call(this, e))).rootRef = u.a.createRef(), n.state = {
        collapse: !1,
        process: !1
      }, n;
    }
    ...
    return pe(t, l["Component"]), Object(ue.a)(t, [{
      ...
      value: function value() {
        return u.a.createElement("div", {
          ...
          className: "cc-notification ".concat(this.props.notification.is_read ? "cc-notification--read" : "", " ").concat(this.props.notification.action_url && this.props.notification.action_url.length ? "cc-cursor" : "", " ")
    ...
    return pe(t, l["Component"]), Object(ue.a)(t, [{
      ...
      value: function value() {
        ...
        return 1 == o.length && n.selectedSectionId != o[0].section && (r({
        ...
        }), this.updateCurrentSection(o[0].section)), u.a.createElement(ve, null, n.sections.map(function (t) {
          var r = {
            key: t.section,
            text: t.section_name,
          ...
          }).length && t.notifications_count || t.section == Z.sections.ALL ? t.unread_notifications_count && t.section != Z.sections.ALL ? u.a.createElement(ge, r, t.unread_notifications_count) : u.a.createElement(ge, r) : null;
        }));
      }
    }, {
      ...
      value: function value() {
        ...
        return u.a.createElement(be, {
          ...
          return t.is_read || t.action_url && t.action_url.length || e.appendToRead(t.notification_id), u.a.createElement(xe, {
            key: t.notification_id,
            notification: t,
            langVars: e.props.langVars,
            onMouseUp: function onMouseUp(n) {
              if (n.stopPropagation(), n.preventDefault(), $(n.target).hasClass("cc-delete")) (function (e) {
                return ie.apply(this, arguments);
              })([t.notification_id]).then(function (n) {
      ...
      value: function value() {
        ...
        return u.a.createElement(me, null, u.a.createElement(ye, {
      ...
      return o.a.wrap(function (e) {
        for (;;) {
          switch (e.prev = e.next) {
            case 0:
              return e.next = 2, te({
                items_per_page: Ce.getState().fetchPerPage,
                page: Ce.getState().fetchPage
              });
            ...
            case 2:
              ...
              s.a.render(u.a.createElement(E, {
                store: Ce
              }, u.a.createElement(_e, null)), document.querySelector("[data-ca-notifications-center-counter]")), Tygh.ceNotificationsCenterInited = !0;
  ...
  Pe(), d.a.ceEvent("on", "ce.notifications_center.reloaded", function (e) {
    Pe().then(function () {
      e && e();
    });
