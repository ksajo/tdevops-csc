(function (_, $) {
  ...
  function fnInitHelpCenter() {
    $.ceAjax('request', _.help_center_server_url + "?version=".concat(_.product_version, "&edition=").concat(_.product_edition, "&lang_code=").concat(_.cart_language, "&dispatch=").concat(_.current_dispatch), {
      caching: false,
      hidden: true,
