...
$schema['discussion.orders.new_post']['receivers'][UserTypes::VENDOR] = [
    MailTransport::getId() => MailMessageSchema::create([
        ...
        'data_modifier' => function (array $data) {
            ...
            $company_id = fn_get_company_id('orders', 'order_id', $data['object']['object_id']);
...
$schema['discussion.pages.new_post']['receivers'][UserTypes::VENDOR] = [
    MailTransport::getId() => MailMessageSchema::create([
        ...
        'data_modifier'   => function (array $data) {
            ...
            $company_id = fn_get_company_id('pages', 'page_id', $data['object']['object_id']);
...
$schema['discussion.products.new_post']['receivers'][UserTypes::VENDOR] = [
    MailTransport::getId() => MailMessageSchema::create([
        ...
        'data_modifier' => function (array $data) {
            ...
            $company_id = fn_get_company_id('products', 'product_id', $data['object']['object_id']);
