 ...
 */
function fn_attachments_import_product_attachments($product_id, $attachments, $attachments_path, $attachments_delimiter, $remove_attachments, $preset)
{
    ...
    foreach ($attachments as $i => $attachment) {
        ...
        if (empty($attachment_data) || YesNo::toBool(Registry::get('addons.attachments.allow_save_attachments_to_server'))) {
            ...
            if ($attachment_files_type === FileUploadTypes::URL) {
                $attachment_data = fn_filter_uploaded_data('attachment_files');
