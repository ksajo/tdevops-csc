...
>
    <ul class="btn-group bulk-edit__wrapper">
        {hook name="product_options:bulk_edit_items"}
            <li class="btn bulk-edit__btn bulk-edit__btn--check-items">
                ...
                {include file="common/check_items.tpl"
                        ...
                        check_statuses=$product_option_statuses
                }
            </li>
            ...
            <li class="btn bulk-edit__btn bulk-edit__btn--status dropleft-mod">
                ...
                <ul class="dropdown-menu">
                    {include file="views/product_options/components/bulk_edit/status.tpl"}
                </ul>
            </li>
            ...
            <li class="btn bulk-edit__btn bulk-edit__btn--actions dropleft-mod">
                ...
                <ul class="dropdown-menu">
                    {include file="views/product_options/components/bulk_edit/actions.tpl"}
                </ul>
            </li>
        {/hook}
    </ul>
