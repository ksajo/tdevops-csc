...
{if $is_enabled && $is_available_for_disaptch}
    ...
    {capture name="storefronts_list"}
        {if $show_all_storefront}
            <a href="{$config.current_url|fn_link_attach:"`$storefront_switcher_param_name`=0"|fn_url}"
        ...
        {foreach $preset_data.storefronts as $storefront}
            ...
            <a href="{$config.current_url|fn_link_attach:"`$storefront_switcher_param_name`=`$storefront[$storefront_switcher_data_name]`"|fn_url}"
