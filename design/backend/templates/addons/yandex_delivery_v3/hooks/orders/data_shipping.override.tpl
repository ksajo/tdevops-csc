{if $shipment.carrier === "Tygh\Addons\YandexDelivery\Services\YandexDeliveryService::MODULE"|constant}
    ...
    {if $yandex_delivery_data.orders.$shipment_id}
        ...
        <div class="tracking-number-right-pane">
            ...
            <div class="control-group">
                <div class="control-label">
                    {__("yandex_delivery_v3.inner_order")}
                </div>
                <div class="controls">
                    {if $yandex_delivery_data.orders.$shipment_id.yandex_id}
                        {$yandex_delivery_data.orders.$shipment_id.yandex_id}
                    {/if}
                </div>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                {$yandex_delivery_data.orders.$shipment_id.status_name}
            </div>
        </div>
        ...
        {if !$yandex_delivery_data.orders.$shipment_id.yandex_id}
            <div class="clearfix">
                {include file="buttons/button.tpl"
                    ...
                    but_role="add"
                    but_target_id="content_add_new_yandex_order_`$shipment.shipment_id`"
